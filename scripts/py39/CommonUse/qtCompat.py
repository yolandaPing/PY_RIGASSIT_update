...
# .Finish time:
"""
QtCompat.py – 统一兼容 Maya 2014–2026 的 PySide1 / PySide2 / PySide6
"""
...
try:
    ...
    try:
        ...
        try:
            ...
            # PySide1 没有 QtWidgets，创建别名保持一致性
            ...
            raise ImportError(u"无法找到 PySide6 / PySide2 / PySide，请检查 Maya Python 环境。")
...
def QtMouseButton(name):
    return _get_enum(QtCore.Qt, name, "MouseButton")
