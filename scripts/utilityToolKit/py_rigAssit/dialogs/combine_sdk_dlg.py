...
class PYCombine_SDK_UI(PyouPersistentWindow):
    ...
    def setup_ui(self, copyright=False):
        ...
        content_layout.addWidget(PY_WIDGEAT.create_title(self.WINDOW_NAME, 15, 30))
    ...
    def create_control_buttons(self, parent_layout):
        ...
        self.help_btn.clicked.connect(partial(self._show_img, "combine_sdk"))
    ...
    def load_selectedAttr_to_TextField(self, attr_field, start_value_field, end_value_field):
        ...
        if selectedAttr != []:
            ...
            mayaPrint.error("Please select the object attribute to load first.")
            return False
